...
namespace BAK_Services.Migrations
{
    ...
    [Migration("20220501165250_addworkspacecolumn")]
    partial class addworkspacecolumn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BAK_Services.Authentication.User", b =>
                {
            ...
            modelBuilder.Entity("BAK_Services.Models.Entities.Task", b =>
                {
                    ...
                    b.Property<int>("MaximumPointsToGet")
                        .HasColumnType("int");

                    b.Property<int>("MinimumPointsCompletedToSuccess")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BAK_Services.Models.Entities.TaskExecution", b =>
                {
                    ...
                    b.Property<string>("ExecutionWorkspace")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BAK_Services.Models.Entities.CourseExecution", b =>
                {
                    ...
                    b.HasOne("BAK_Services.Authentication.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BAK_Services.Authentication.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
